...
import edu.bluejack22_1.GMoneysoLVer.databinding.FragmentCategoryIncomeBinding;
...
public class CategoryIncomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCategoryIncomeBinding.inflate(
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        for (QueryDocumentSnapshot snapshot : value){
                            if(snapshot.getString("categoryName") != null && snapshot.getString("categoryType") != null){
                                if (snapshot.getString("categoryType").equalsIgnoreCase("income")){
